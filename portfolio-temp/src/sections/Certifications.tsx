...
const certifications: Cert[] = [
  ...
  },
  {
    ...
    color: {
      ...
      shadow: "0 0 35px rgba(52,211,153,0.18), 0 20px 40px rgba(0,0,0,0.4)",
      gradientBlob: "radial-gradient(circle, rgba(52,211,153,0.28) 0%, rgba(16,185,129,0.12) 50%, transparent 70%)",
      divider: "rgba(52,211,153,0.25)",
      linkHover: "#34d399",
    },
  },
];
